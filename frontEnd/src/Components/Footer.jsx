    ...
    render() {
        ...
        <NavbarBrand href="/" className="mr-auto">AppPraise Me 2019</NavbarBrand>
            <Nav>
                ...
                <NavItem>
                    <NavLink className="logo" id="resume" href="https://docs.google.com/document/d/10WLVziclEpZTavVlsRC3ToLlMVfBwFeCMBfGVLkJ7a4/edit?usp=sharing" ><img src="/Logos/resume.png" alt="Resume Logo"/> </NavLink>
                </NavItem>
            </Nav>
        </Navbar>
        </div>
